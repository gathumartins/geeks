...
<span className="text-[#0A475C] group-hover:text-[#EF801E] text-base hidden sm:inline-block font-normal">+254 728 429 252</span></Link>
      ...
      <main className="my-[80px]">
        <section className="flex flex-col sm:flex-row justify-between">
          ...
          <p className="text-black max-w-[420px] text-sm font-normal mt-[20px]">Our new website is coming soon, with a user-friendly experience. Stay tuned for the big reveal!</p>
          </div>
